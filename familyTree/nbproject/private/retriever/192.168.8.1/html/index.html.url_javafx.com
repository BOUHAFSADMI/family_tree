...
<head>
<meta name="csrf_token" content="Oa/gpo5zjasgmqREo7C2ygoyGnaQe3uH"/>
<meta name="csrf_token" content="CY1zWUgn3p87QrSTF1/AUXT9ZZ5Ilz9B"/>
...
g_wanIPAddress = ret.response.WanIPAddress;
g_wanIPv6Address = ret.response.WanIPv6Address;
}
}, {
sync : true
}
...
|| (incoming_url.indexOf(GATEWAY_DOMAIN)==0) || (incoming_url.indexOf(g_wanIPAddress)==0)
|| (Ipv6addressisSame(incoming_url.slice(1, -1), g_wanIPv6Address))){
